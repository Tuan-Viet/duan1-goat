<div class="carts_check mt40 container">
    ...
    <table id="view_cart" class="mt50">
        ...
        <!-- <tfoot> -->
            <tr>
                <td class="total_pro-cart"><p><?= $cart[8] ?> <sup>đ</sup></p></td>
            </tr>
            <?php
                $dem+=1;
                $thanhtoan+=$cart[8];
